...
.wrap-hero::before{content:'';position:absolute;left:50%;top:-60px;transform:translateX(-50%);
width:min(1200px,130vw);height:360px;z-index:-1;pointer-events:none;filter:blur(6px);
background:radial-gradient(58% 100% at 50% 0,color-mix(in srgb,var(--c1) 24%,transparent),transparent 72%),
radial-gradient(46% 90% at 78% 8%,color-mix(in srgb,var(--c5) 20%,transparent),transparent 72%),
radial-gradient(46% 90% at 22% 12%,color-mix(in srgb,var(--c4) 16%,transparent),transparent 72%)}
.wrap-hero .hero h1{background:linear-gradient(90deg,var(--c1),var(--c5));
...
border-radius:var(--radius);border-left:3px solid var(--c1);
transition:box-shadow .15s,transform .15s}
.tile:hover{box-shadow:0 2px 8px rgba(15,23,42,.08);transform:translateY(-1px)}
.tiles .tile:nth-child(6n+2){border-left-color:var(--c2)}
.tiles .tile:nth-child(6n+3){border-left-color:var(--c3)}
.tiles .tile:nth-child(6n+4){border-left-color:var(--c4)}
.tiles .tile:nth-child(6n+5){border-left-color:var(--c5)}
.tiles .tile:nth-child(6n+6){border-left-color:var(--c6)}
.tile .tile-val{color:var(--c1)}
.tiles .tile:nth-child(6n+2) .tile-val{color:var(--c2)}
.tiles .tile:nth-child(6n+3) .tile-val{color:var(--c3)}
.tiles .tile:nth-child(6n+4) .tile-val{color:var(--c4)}
.tiles .tile:nth-child(6n+5) .tile-val{color:var(--c5)}
.tiles .tile:nth-child(6n+6) .tile-val{color:var(--c6)}
